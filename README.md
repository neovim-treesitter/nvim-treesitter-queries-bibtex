# nvim-treesitter-queries-bibtex

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-bibtex/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-bibtex/actions/workflows/validate.yml)

Neovim tree-sitter queries for **bibtex**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-bibtex",
...
- [ ] Changes are scoped to `bibtex` — do not include files for other languages
